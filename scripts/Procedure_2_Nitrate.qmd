...
flow_injections <- 
  ...
  orbi_flag_outliers(agc_window = c(2, 98)) 
...
deltas |> orbi_export_data_to_excel("nitrate_data_all.xlsx")
...
deltas_summary |>
  ...
  orbi_export_data_to_excel("table_nitrate_ratios.xlsx") # exports the final dataset into an Excel file
```
...
deltas_summary |>
  ...
  orbi_export_data_to_excel("table_nitrate_deltas.xlsx") # exports the final dataset into an Excel file
```
